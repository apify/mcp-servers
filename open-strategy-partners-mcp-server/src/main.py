...
SERVER_NAME = 'open-strategy-partners-mcp-server'  # Name of the MCP server, without spaces
...
async def main() -> None:
    ...
    2. DOMAIN-SPECIFIC CHARGING (OSP example):
       - Charge different amounts for different tools
       - get_value_map_positioning_guide: $0.01 per search
       - get_meta_guide: $0.001 per listing
       - get_editing_codes: $0.005 per download
       - get_writing_guide: $0.02 per paper read
       - get_on_page_seo_guide: $0.01 per guide
