...
SERVER_NAME = 'dictionary-mcp-server'  # Name of the MCP server, without spaces
...
async def main() -> None:
    ...
    2. DOMAIN-SPECIFIC CHARGING (Dictionary example):
       - Charge different amounts for different tools
       - define: $0.001 per definition lookup
       - example_usage: $0.001 per examples lookup
       - synonyms: $0.001 per synonyms lookup
