...
# Note: AUTHORIZED_TOOLS, ChargeEvents, and get_charge_event should be defined in your project
...
async def create_gateway(  # noqa: PLR0915
    ...
    if capabilities.tools:
        ...
        async def _list_tools(_: Any) -> types.ServerResult:
            ...
            await charge_mcp_operation(actor_charge_function, 'tool-list')
        ...
        async def _call_tool(req: types.CallToolRequest) -> types.ServerResult:
            ...
            if tool_whitelist and tool_name in tool_whitelist:
                event_name, default_count = tool_whitelist[tool_name]
                
                # Use default count for all tools
                count = default_count

                await charge_mcp_operation(actor_charge_function, event_name, count)
                ...
                # No whitelist - charge with default event
                await charge_mcp_operation(actor_charge_function, 'tool-call')
