...
SERVER_NAME = 'kiwi-mcp-server'  # Name of the MCP server, without spaces

server_type = ServerType.HTTP  # Using HTTP transport for Kiwi MCP server
MCP_SERVER_PARAMS = RemoteServerParameters(  # noqa: ERA001, RUF100
    url='https://mcp.kiwi.com',  # Kiwi MCP server URL
