...
class ChargeEvents(str, Enum):
    ...
    CONVERT_MARKDOWN_TO_MINDMAP = 'convert_markdown_to_mindmap'
...
TOOL_WHITELIST = {
    ChargeEvents.CONVERT_MARKDOWN_TO_MINDMAP.value: (ChargeEvents.CONVERT_MARKDOWN_TO_MINDMAP.value, 1),
}
