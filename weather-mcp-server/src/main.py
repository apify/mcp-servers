...
SERVER_NAME = 'weather-mcp-server'  # Name of the MCP server, without spaces
...
async def main() -> None:
    ...
    2. DOMAIN-SPECIFIC CHARGING (Weather example):
       - Charge different amounts for different tools
       - get_current_weather: $0.005 per weather lookup
       - get_weather_by_datetime_range: $0.01 per historical data request
